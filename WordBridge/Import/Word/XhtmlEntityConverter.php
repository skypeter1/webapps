...
class XhtmlEntityConverter
{
    ...
    /**
     * Converts html entities (ie, &nbsp; to numerical equivalents (&#160;) in $str.
     * @param string $str
     */
    public static function convertToNumericalEntities($str, $entityMap = null)
    {
        if(is_null($entityMap))
        {
            $entityMap = self::$htmlEntityMap;
        }
        return strtr($str, $entityMap);
    }
}